export PJDIR := /root/pjproject-2.14.1
...
export STD_CPP_LIB := /root/android-ndk-r25c/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
        ...
        $(PJ_VIDEO_LDFLAGS) \
         /root/android-ndk-r25c/toolchains/llvm/prebuilt/linux-x86_64/lib64/clang/14.0.7/lib/linux/aarch64/libunwind.a -latomic -target aarch64-none-linux-android33 -no-canonical-prefixes -Wl,--gc-sections -Wl,--build-id=sha1 -nostdlib++ -Wl,--no-undefined -Wl,--fatal-warnings -lc -lm  
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
        ...
        $(APP_THIRD_PARTY_EXT)\
        $(PJLIB_LDLIB) \
        -lmediandk -lm  /root/android-ndk-r25c/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so -lOpenSLES -llog -lGLESv2 -lEGL -landroid
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lmediandk -lm  /root/android-ndk-r25c/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so -lOpenSLES -llog -lGLESv2 -lEGL -landroid
